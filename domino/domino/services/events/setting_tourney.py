...
def get_one_configure_tourney(request:Request, tourney_id: str, db: Session):  
    ...
    result.data = {
        ...
        "use_segmentation": True if not db_tourney.use_segmentation else False,
        "use_penalty": True if not db_tourney.use_penalty else False,
        "use_bonus": True if not db_tourney.use_bonus else False,
