...
@singleprofile_route.get("/profile/single/{profile_id}", response_model=ResultData, summary="Obtain a list of Single Player profile")
def get_profile(
    request: Request,
    profile_id: str,
    page: int = 1, 
...
@singleprofile_route.get("/profile/single/one/{id}", response_model=ResultObject, summary="Get a Single Profile of Player for your ID.")
