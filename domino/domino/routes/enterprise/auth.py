...
from domino.services.enterprise.users import new as new_user, check_security_code
from domino.services.resources.country import get_all
from domino.services.enterprise.auth import auth
...
def verify_security_code(
    ...
    return check_security_code(request=request, username=username, security_code=security_code, db=db)
