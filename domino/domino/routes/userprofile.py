...
@singleprofile_route.post("/singleprofile", response_model=ResultObject, summary="Create a Single Profile of Player")
...
@singleprofile_route.delete("/singleprofile/{id}", response_model=ResultObject, summary="Remove Single Profile for your ID")
...
@singleprofile_route.put("/singleprofile/{id}", response_model=ResultObject, summary="Update Single Profile for your ID")
